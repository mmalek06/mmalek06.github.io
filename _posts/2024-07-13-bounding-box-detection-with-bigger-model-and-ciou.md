...
5. Arctan function takes values from $\pi^2$ to $-\pi^2$ which means that its values are always normalized to this interval. The maximum difference between two arctan values is $\pi$.
